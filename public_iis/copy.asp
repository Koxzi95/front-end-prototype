...
<html>
  <head>
    <title>QAL | Copy Catalogue | Library Management </title>
  ...
  <body>
    <div class="pageheader">
      ...
      <h1>Copy Catalogue - Library Management</h1>
    </div>
    <div class="grid grid-pad">
      <div class="col-10-12">
        <div class="content">
          ...
          REM run the query and store the result in a variable. this query selects all records from the copy table
		  Set QueryResult = DBConn.Execute("SELECT * FROM COPY")
		  REM display the results of the query in a html table using a loop 
		...
		REM end the query and close the connection to the oracle database 
        QueryResult.Close
        DBConn.Close
        %>
      </div>
    ...
    <div class="col-2-12">
      <div class="content">
        ...
        <button class="buttonsasp" id="btnClear" onClick="location.href = 'http://my.tech.dmu.ac.uk/~p13198051/searchcopy.html'">&nbspSearch Copies&nbsp</button>
        <button class="buttonsasp" id="btnClear" onClick="location.href = 'http://my.tech.dmu.ac.uk/~p13198051/addcopy.html'">&nbspAdd Copies&nbsp</button>
        <button class="buttonsasp" id="btnClear" onClick="location.href = 'http://my.tech.dmu.ac.uk/~p13198051/delcopy.html'">&nbspDelete Copies&nbsp</button>
        <button class="buttonsasp" id="btnClear" onClick="location.href = 'http://my.tech.dmu.ac.uk/~p13198051/editcopy.html'">&nbspEdit Copies&nbsp</button>
