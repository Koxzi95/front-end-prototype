        ...
        <div class="grid grid-pad">
            <div class="col-10-12">
                <div class="content">
                    ...
                    REM run the query and store the result in a variable. this query selects all payments for a hard coded borrower ID
					Set QueryResult = DBConn.Execute("SELECT * FROM PAYMENT WHERE FK1_BOR_ID = 'B09001'")
            ...
            <div class="col-2-12">
                <div class="content">
                    ...
                    <button class="buttonsasp" id="btnClear" onClick="location.href = 'http://my.tech.dmu.ac.uk/~p13198051/searchpay_user.html'">&nbspSearch&nbsp</button>
                    <button class="buttonsasp" id="btnClear" onClick="location.href = 'http://my.tech.dmu.ac.uk/~p13198051/makepay_user.html'">&nbspMake Payment&nbsp</button>
