...
<html>
  <head>
    <title>QAL | User Management | Library Manager</title>
  ...
  <body>
    <div class="pageheader">
      ...
      <h1>User Management - Library Manager </h1>
    </div>
    <div class="grid grid-pad">
      <div class="col-10-12">
        <div class="content">
          ...
          REM run the query and store the result in a variable. this query selects all borrowers in the system
		  Set QueryResult = DBConn.Execute("SELECT * FROM BORROWER")
      ...
      <div class="col-2-12">
        <div class="content">
          ...
          <button class="buttonsasp" id="btnClear" onClick="location.href = 'http://my.tech.dmu.ac.uk/~p13198051/searchborrower.html'">&nbspSearch&nbsp</button>
          <button class="buttonsasp" id="btnClear" onClick="location.href = 'http://my.tech.dmu.ac.uk/~p13198051/addborrower.html'">&nbspAdd&nbsp</button>
          <button class="buttonsasp" id="btnClear" onClick="location.href = 'http://my.tech.dmu.ac.uk/~p13198051/amend_borrower.html'">&nbspEdit&nbsp</button>
          <button class="buttonsasp" id="btnClear" onClick="location.href = 'http://my.tech.dmu.ac.uk/~p13198051/delborrower.html'">&nbspDelete&nbsp</button>
