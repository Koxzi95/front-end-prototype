...
<html>
    <head>
        <title>QAL | Reservations | Library Staff</title>
    ...
    <body>
        <div class="pageheader">
            ...
            <h1>Reservations - Library Staff</h1>
        </div>
        <div class="grid grid-pad">
            ...
            <div class="col-2-12">
                <div class="content">
                    ...
                    <button class="buttonsasp" id="btnClear" onClick="location.href = 'http://my.tech.dmu.ac.uk/~p13198051/searchres_staff.html'">&nbspSearch&nbsp</button>
