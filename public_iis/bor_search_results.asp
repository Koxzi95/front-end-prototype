...
<html>
  <head>
    <title>QAL Search Results</title>
    ...
    <div class="grid grid-pad">
      <div class="col-10-12">
        <div class="content">
          ...
          REM store the data from the input form in a variable
          script_variable_1 = request("bor_id_input")
          REM store the sql command in a variable. this query selects all results from the borrower table where borrower ID matches
          QueryToRun = "SELECT * FROM borrower WHERE Bor_Id = '" & script_variable_1 & "';"
          ...
          REM run the qery and store the result in a variable 
		  Set QueryResult = DBConn.Execute(QueryToRun)
          REM display the result of the query in a html table using a loop
