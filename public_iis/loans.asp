    ...
    <div class="grid grid-pad">
      <div class="col-10-12">
        <div class="content">
          ...
          REM run the query and store the result in a variable. this query selects all loans 
      ...
      <div class="col-2-12">
        <div class="content">
          ...
          <button class="buttonsasp" id="btnClear" onClick="location.href = 'http://my.tech.dmu.ac.uk/~p13198051/searchloans.html'">&nbspSearch&nbsp</button>
          <button class="buttonsasp" id="btnClear" onClick="location.href = 'http://aspen.dmu.ac.uk/p13198051/bcat.asp'">&nbspEdit&nbsp</button>
