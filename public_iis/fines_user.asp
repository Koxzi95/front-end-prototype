...
<html>
    <head>
        <title>QAL | Management | User</title>
        ...
        <div class="grid grid-pad">
            <div class="col-10-12">
                <div class="content">
					...
					REM run the query and store the result in a variable. this query selects all fines from the fine table and is hard coded to display results for borrower no.B09001
                    Set QueryResult = DBConn.Execute("SELECT * FROM FINE WHERE FK1_BOR_ID = 'B09001' ")
            ...
            <div class="col-2-12">
                <div class="content">
                    ...
                    <button class="buttonsasp" id="btnClear" onClick="location.href = 'http://my.tech.dmu.ac.uk/~p13198051/searchfinesuser.html'">&nbspSearch&nbsp</button>
