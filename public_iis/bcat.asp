...
<html>
  <head>
    <title>QAL | Management | Book Catalogue</title>
  ...
  <body>
    ...
    <div class="col-2-12">
      <div class="content">
        ...
        <button class="buttonsasp" id="btnClear" onClick="location.href = 'http://my.tech.dmu.ac.uk/~p13198051/findbook.html'">&nbspSearch Books&nbsp</button>
        <button class="buttonsasp" id="btnClear" onClick="location.href = 'http://my.tech.dmu.ac.uk/~p13198051/addbook.html'">&nbspAdd Book&nbsp</button>
        <button class="buttonsasp" id="btnClear" onClick="location.href = 'http://my.tech.dmu.ac.uk/~p13198051/editbook.html'">&nbspEdit Book&nbsp</button>
        <button class="buttonsasp" id="btnClear" onClick="location.href = 'http://my.tech.dmu.ac.uk/~p13198051/delbook.html'">&nbspDelete Book&nbsp</button>
        <button class="buttonsasp" id="btnClear" onClick="location.href = 'http://aspen.dmu.ac.uk/p13198051/copy.asp'">&nbspView Copies&nbsp</button>
