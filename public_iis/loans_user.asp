    ...
    <div class="grid grid-pad">
      <div class="col-10-12">
        <div class="content">
          ...
          REM run the query and store the result in a variable. this query selects all loans for a hard coded borrower id 
		  Set QueryResult = DBConn.Execute("SELECT * FROM LOAN WHERE FK2_BOR_ID = 'B09001'")
      ...
      <div class="col-2-12">
        <div class="content">
          ...
          <button class="buttonsasp" id="btnClear" onClick="location.href = 'http://my.tech.dmu.ac.uk/~p13198051/searchloans_user.html'">&nbspSearch&nbsp</button>
