...
<html>
    <head>
        <title>QAL | Management | Payments</title>
        ...
        <div class="grid grid-pad">
            ...
            <div class="col-2-12">
                <div class="content">
                    ...
                    <button class="buttonsasp" id="btnClear" onClick="location.href = 'http://my.tech.dmu.ac.uk/~p13198051/searchpay.html'">&nbspSearch&nbsp</button>
